...
def has_autogenerated_header(content_bytes: bytes) -> str | None:
    """Return ``'autogenerated'`` if the first 512 B carries a known generator marker.

    v2.6.0 polish: the window dropped from 4 KiB -> 512 B. The original
    cap matched documentation files that merely *discuss* the autogen
    markers (e.g. this safeguards reference doc itself) -- they hit the
    marker by line 60-80, well inside 4 KiB but well past the line
    1-3 range where real codegen tools place the comment. 512 B is
    enough for the typical 1-3 line shebang / preamble / pragma + the
    one-line generated-marker that follows it. Docs that talk ABOUT
    generators escape the false-positive.
    """
