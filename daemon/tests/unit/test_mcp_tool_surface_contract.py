...
# Snapshot of the published MCP tool surface as of 2026-06-09
# (post-v5.25.0). Counts: 12 safe + 14 confirm + 4 danger = 30.
...
# for the Phase 4b confirm-then-apply (the first node mutation);
# v5.25.0 added ``mnemo_help`` (safe) for MCP-only-host discovery; the
...
EXPECTED_TOOLS: frozenset[str] = frozenset(
    {
        ...
        "mnemo_help",  # v5.25.0: discovery for MCP-only hosts (workstream B)
